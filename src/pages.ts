...
import { HumanPracticesPage } from "./containers/HumanPractices/HumanPracticesPage";
import WetlabHome from "./containers/Wetlab/wetlabhome";
import WetlabPOV from "./containers/Wetlab/wetlabdesign";
    ...
    folder: [
      {
        ...
        lead: "Where biology meets wildfire containment",
      },
      {
        name: "Overview",
        title: "Wetlab Overview",
        path: "/overview",
        component: WetlabPOV,
        lead: "Comprehensive overview of our wetlab work and results",
      },
      {
        name: "Experiments",
        title: "Experiments",
  ...
  },
  {
    ...
    folder: [
      ...
      },
      {
        ...
        path: "/human-practices/integrated",
        component: require("./containers/HumanPractices/Integrated/integratedpage.tsx").default,
        lead: "How feedback, dialogue, and collaboration shaped our project design and impact.",
      },
      {
        name: "Meeting iGEM Teams",
        title: "Meeting iGEM Teams",
        path: "/meetings",
        component: require("./containers/HumanPractices/MeetingsPage/MeetingsPage.tsx").default,
        lead: "Building connections and sharing knowledge within the iGEM community.",
      },
    ],
  },
];
